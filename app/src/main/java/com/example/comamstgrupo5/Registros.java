package com.example.comamstgrupo5;
...
public class Registros extends AppCompatActivity {
    ...
    public void solicitarTemperaturas() {
        ...
        JsonArrayRequest requestRegistros = new JsonArrayRequest(Request.Method.GET, url_registros, null, new Response.Listener<JSONArray>() {
            ...
            public Map<String, String> getHeaders() {
                ...
                params.put("Authorisation", "JWT  " + token);
                return params;
            }
        };
    ...
    private void mostrarTeperaturas(JSONArray temperaturas) {
        String registroId;
            ...
            for (int i = 0; i < temperaturas.length(); i++) {
                ...
                if (registroTemp.getString("key").equals("temperatura")) {
                    ...
                    if (temperaturasTVs.containsKey(registroId) && fechasTVs.containsKey(registroId)) {
                        ...
                        fechaRegistro.setText(registroTemp.getString("date created"));
